...
|---|---|---|---|---|
| **AI Coding Agents 101 for Business Folks** | teaching | [open ▶](https://myeongseok-gwon.github.io/presentation/teaching/ai-coding-agents-101-for-business/index.html) | [open](https://myeongseok-gwon.github.io/presentation/teaching/ai-coding-agents-101-for-business/index.ref.html) | [PDF](teaching/ai-coding-agents-101-for-business/ai-coding-agents-101-for-business.pdf) |
...
![AI Coding Agents 101 — contact sheet](teaching/ai-coding-agents-101-for-business/ai-coding-agents-101-for-business.contact.png)
...
node _template/build.mjs teaching/ai-coding-agents-101-for-business

# 2. present locally (interactive widgets need HTTP, not file://)
npx serve teaching/ai-coding-agents-101-for-business    # then open index.html

# 3. export PDF + contact sheet (first run downloads headless Chrome)
cd _template && npm install
node ../_template/export.mjs teaching/ai-coding-agents-101-for-business
